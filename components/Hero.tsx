...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative bg-gray-200 dark:bg-gray-900/50 py-20 sm:py-32 overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center opacity-10 dark:opacity-20" style={{backgroundImage: "url('https://images.unsplash.com/photo-1614091119322-2b694b878f84?q=80&w=1920&auto=format&fit=crop')"}}></div>
