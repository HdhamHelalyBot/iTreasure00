        ...
        <div className="grid md:grid-cols-3 gap-8 text-center md:text-start">
          ...
          <div className="md:col-span-2 flex justify-center md:justify-end">
            <div className="flex space-x-6 rtl:space-x-reverse items-center">
              <a href="#" className="hover:text-brand-red transition-colors">{t('aboutUs')}</a>
              <a href="#" className="hover:text-brand-red transition-colors">{t('termsAndConditions')}</a>
              <a href="#" className="hover:text-brand-red transition-colors">{t('privacyPolicy')}</a>
            </div>
          </div>
        </div>
