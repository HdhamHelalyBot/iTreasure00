          ...
          {categories.map((category: Category) => {
            ...
            return (
              <div key={category.id} className="group bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden cursor-pointer transform transition-transform duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-brand-red/20">
                <div className="relative w-full h-40 bg-gray-100 dark:bg-gray-700 flex items-center justify-center p-4 overflow-hidden">
                  <Icon className="w-16 h-16 text-gray-500 dark:text-gray-400 group-hover:text-brand-red group-hover:scale-110 transition-all duration-300" />
